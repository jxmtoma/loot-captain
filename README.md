...
- Keep a per-character local wishlist; a single wishlist star per item opens a character picker when several characters are selected, with comparison against any selected character's wishlist.
